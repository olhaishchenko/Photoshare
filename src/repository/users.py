...
#     """
#     The **get_user_profile** function returns a UserModelProfile object containing the user's username, email,
...
#     :return: A usermodelprofile object
#     """
#     user = db.query(User).filter(User.username == username).first()
#     if user:
#         post_count = db.query(Image).filter(Image.user_id == user.id).count()
